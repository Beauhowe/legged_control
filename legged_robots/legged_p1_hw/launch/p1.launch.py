...
def launch_setup(context, *args, **kwargs):
    ...
    posture_transition_duration = LaunchConfiguration("posture_transition_duration").perform(context)
    ...
    gait_bridge = Node(
        ...
        parameters=[
            ...
            {"posture_transition_duration": float(posture_transition_duration)},
